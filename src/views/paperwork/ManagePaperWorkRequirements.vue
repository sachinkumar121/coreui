<template>
  ...
  <div>
    <div class="col-md-12 text-right">
        <button class="btn btn-success"  @click="$router.push('/paperwork/manage_paperwork_requirements/add_edit')"> Add New Paperwork Requirement </button>
        &nbsp;
        <button class="btn btn-primary"  @click="$router.push('/paperwork/manage_document_templates')"> Manage Blank Forms/Waiver Templates </button>
    </div>
    <br>
    <CRow>
      <CCol sm="12">
