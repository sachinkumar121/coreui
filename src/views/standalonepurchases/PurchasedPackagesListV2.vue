<template>
    <div class="pt-2">
        ...
        <div>
                ...
                <table class="table table-bordered table-purchase">
                    <thead class="stikcy-top">
                        <tr>
                            ...
                            <th style="width:15%;">Redeem Code</th>
                            <th style="width:15%;">Assign to</th>
                            <th style="width:20%;">Purchased Date</th>
                            <th style="width:30%;">Action</th>
                        </tr>
                    </thead>
                    <tbody v-if="list.length" class="tbody-main">
                        <tr v-for="item in list" :key="item._id">
                            <td colspan="5">
                                <table class="w-100 inner-table">
                                    <tr>
                                        <td style="width:20%;">{{ item.package_name }}
                                            <span
                                            ...
                                            >
                                               <br />
                                                <p
                                                    ...
                                                    ><strong>Price:</strong> {{ currency_symbol
                                                    }}{{ item.package_sold_price }}<br />
                                                    <strong>Balance:</strong> {{ currency_symbol
                                                    }}{{
                                                        roundto2digits(
                                                ...
                                                >
                                                <p v-else>Not yet paid</p>
                                            </span>
                                        </td>
                                        <td style="width:15%;">
                                            <span class="redeem-code">{{ item.redemption_code }}</span>
                                        </td>
                                        <td style="width:15%;">
                                            {{ item.assigned_customer_data.first_name }}
                                                {{ item.assigned_customer_data.last_name }}
                                        </td>
                                        <td style="width:20%;" class="purchase-col">
                                            <p class="mb-0 d-flex"
                                                    v-if="item.is_purchase_complete == true"
                                                    >Purchased:
                                                    <span class="d-flex gap-1 ps-1">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
                                                        <path d="M12 2.25V5.25M6 2.25V5.25M3 8.25H15M3 5.25C3 4.85218 3.15804 4.47064 3.43934 4.18934C3.72064 3.90804 4.10218 3.75 4.5 3.75H13.5C13.8978 3.75 14.2794 3.90804 14.5607 4.18934C14.842 4.47064 15 4.85218 15 5.25V14.25C15 14.6478 14.842 15.0294 14.5607 15.3107C14.2794 15.592 13.8978 15.75 13.5 15.75H4.5C4.10218 15.75 3.72064 15.592 3.43934 15.3107C3.15804 15.0294 3 14.6478 3 14.25V5.25Z" stroke="#828282" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                                        <path d="M8.25 12C8.25 12.1989 8.32902 12.3897 8.46967 12.5303C8.61032 12.671 8.80109 12.75 9 12.75C9.19891 12.75 9.38968 12.671 9.53033 12.5303C9.67098 12.3897 9.75 12.1989 9.75 12C9.75 11.8011 9.67098 11.6103 9.53033 11.4697C9.38968 11.329 9.19891 11.25 9 11.25C8.80109 11.25 8.61032 11.329 8.46967 11.4697C8.32902 11.6103 8.25 11.8011 8.25 12Z" stroke="#828282" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                                                      </svg>
                                                    {{
                                        ...
                                        <td style="width:30%;">
                                            <button
                                                ...
                                                @click="showPackageItems(item)">
                                                <span>Show Items Table</span>     
                                            </button>
                                            &nbsp;
                                            <button
                                ...
                                <div v-if="show_package_items && item._id == purchase_package._id" class="mt-3">
                                    <table
                                        v-if="
                                        ...
                                        "
                                        id="tableItem"
                                        class="table table-bordered border border-1 table-item"
                                    >
                                        <thead>
                                            <tr>
                                                <th>Item</th>
            ...
            <CModal size="xl" :visible="show_package_usage" @close="closeShowPackageUsage()">
                <CModalHeader>
...
export default {
    ...
    methods: {
        showPackageItems(purchase_package) {
            this.show_package_items = true;
