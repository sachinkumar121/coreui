  ...
  <div>
    <CContainer fluid>
      <CRow class="justify-content-center">
        <CCol md="12">
          <CCard class="mx-12 mb-0">
            <CCardBody class="p-12">
              <Alerts 
              :alertData="alertData" 
              :show="show"
                ...
                <div class="form-body">
                  ...
                  <div>
                      <div class="col-md-12 text-left">
                          <ul>
                              <li>
                                  This form is for business owner to signup their new location.
                              </li> 
                              <li>
                                  A new location is an independent business with the difference that owners can switch between them easily.
                              </li> 
                         </ul>
                         <hr>
                      </div>
            ...
            <div id="id_full_panel" v-if="show_full_panel">
                  <div class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <div class="form-group">
                            <label class="control-label">
                            <b>Location name (short)</b>
                            </label>
                            <input
                            class="form-control placeholder-no-fix"
                            type="text"
                            v-model="ml_location_short_name"
                            >
                            <p
                            class="error-msg"
                            v-if="v$.ml_location_short_name.$dirty && v$.ml_location_short_name.minLength.$invalid"
                            >Min length is 2.</p>
                            <p
                            class="error-msg"
                            v-if="v$.ml_location_short_name.$dirty && v$.ml_location_short_name.maxLength.$invalid"
                            >This max length is 20.</p>
                 ...
                 <!-- Ein, type, etc -->
                  <div v-if="register_in_location_add_mode!=true" class="row">
                     <div class="col-md-6">
                      <div class="form-group">
                        <label class="control-label">
                          <b>Ownership Type</b>
                ...
                <!-- business start MCC code -->
                  ...
                  <div v-if="register_in_location_add_mode!=true" class="row">
                    ...
                    <div class="col-md-4">
                      <div class="form-group">
                        <label class="control-label">
                         <b>Highest per sale ($)</b> <CIcon name="cil-CommentSquare"  
                        v-c-popover="{
                        header: 'Info',
                        trigger: 'click',
                ...
                <!-- Owner details -->
                  ...
                  <div v-if="register_in_location_add_mode!=true" class="row">
                    <div class="col-md-6">
                      <div class="form-group">
                        <label class="control-label">
                          <b>Password for app</b> <CIcon name="cil-CommentSquare"  
                        v-c-popover="{
                        header: 'Info',
                        trigger: 'click',
                 ...
                 <div  v-if="register_in_location_add_mode!=true" class="row">
                    <div class="col-md-4">
                      <div class="form-group">
                        <label class="control-label">
                          <b>Owner's SSN</b> &nbsp; <CIcon name="cil-CommentSquare"  
                        v-c-popover="{
                        header: 'Info',
                        trigger: 'click',
                     ...
                     <div class="col-md-4">
                      <div class="form-group">
                        ...
                        <input  v-if="register_in_location_add_mode!=true"
                          class="form-control placeholder-no-fix"
                          type="text"
                  ...
                  <div  v-if="register_in_location_add_mode!=true" class="row">
                    <div class="col-md-4">
                      <div class="form-group">
                        <label class="control-label">
                          <b>Owner's Date of Birth</b> &nbsp; <CIcon name="cil-CommentSquare"  
                        v-c-popover="{
                        header: 'Info',
                        trigger: 'click',
                  ...
                  <div  v-if="register_in_location_add_mode!=true">
                      <div class="col-md-12 text-left">
                        <hr>
                           <h5 align="center"> Banking Information </h5>
                         <hr>
                      </div>
                  </div>  
                  ...
                  <div  v-if="register_in_location_add_mode!=true" class="row">
                    <div class="col-md-10">
                        ...
                        @click="withdrawalCheckChange"
                            ...
                            class="md-check"> &nbsp; Bank account for withdrawals same as deposit account.
                    </div>
                   
                  </div>
                  
                <div id="idwithdrawbank" v-if="show_withdrawal_bank">
                  <div class="row">
                    <div class="col-md-6">
                          <div class="form-group">
                        <label class="control-label">
                ...
                </div> <!-- END wITHDRAWal (idwithdrawbank) -->
                ...
                <div class="row">
                  ...
                  <!-- <div class="row">
                    <div class="col-md-10">
                        <input type="checkbox" id="new_subsc" v-model="agree_to_additional_subscription" 
                            class="md-check"> &nbsp; 
                            I'm aware of recurring subscription charges of a new location and agree to them.
                          <br>
                    </div> 
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <button class="btn btn-success float-end"  :disabled = "create_account_disabled">Create Location</button>
                    </div>
...
export default {
  ...
  data() {
    ...
    register_in_location_add_mode: true,
    agree_to_additional_subscription: false,
    seq_http_calls: 0,
    scheduled_objects    : [],
...
//    legal_business_name: {required },
    ml_location_short_name: {required, minLength: minLength(2), maxLength: maxLength(20)},
...
test_data()
{
    this.business_name = "test business n"
    this.legal_business_name = "legal business n"
    this.address_line1 = "104 address line 1"
   ...
   hide_initial_panels()
   {
    ...
    onProceedWithPaymentProcessing(event)
    {
        let value = event.target.value;
    ...
    register(e) {
      ...
      if (!this.v$.$invalid) {
        ...
        let data = {
            ...
            ein                              : this.ein,
            legal_business_name              : this.business_name, //for now set same as business this.legal_business_name,
            ml_location_short_name           : this.ml_location_short_name,
        ...
        console.log(data)
        console.log("asdasd-sa-d-sad");
       // return;
        this.$schedsdk.multi_location_add_location(data).then(result => {
            if (result.status == 1) 
            {
                this.$router.push("/multi_location");
            } 
            else 
            {    
                this.create_account_disabled = false;
