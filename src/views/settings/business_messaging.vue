<template>
  <div class="pt-2">
    <div class="row">
        <h5>Manage Business Text/SMS messaging</h5><br><br>
    </div>
    <FilterSection>
        <template v-slot:search-input>
            <label class="control-label"><b>Search Settings</b></label>
            <input 
            v-model="search"
        ...
        <template v-slot:actions>
            <button class="btn btn-primary mt-4" 
                    @click="$router.push('/settings/booking_reminder_settings')">Manage Booking Notifications </button>
            <span>&nbsp;&nbsp;</span>
        ...
        <div class="row controls-div">
            <div class="col-md-8">
                <div class="form-group" >
                    <label class="control-label"><b>Phone number used for your business text/SMS: </b> &nbsp; 
                   <strong 
                   v-if="this.settings2_ro_data.text_messaging_phone_number">{{this.settings2_ro_data.text_messaging_phone_number}}</strong></label> &nbsp; 
          ...
          <tbody v-if="list.length">
              <tr v-for="item in listofsettings"   :key="item.name">
                  ...
                  <td v-if="item.type == 'group'" colspan="2" class="text-center"> 
                        <strong>{{item.name}}</strong>  <CIcon v-if="item.description && item.description.length>2" 
                  ...
                  <td v-else-if="item.type == 'input'"> 
                     <span class="col-md-8 d-inline-block"><input 
                          class="form-control placeholder-no-fix" 
                   ...
                   <td v-else-if="item.type == 'const_text'"> 
                       <label>{{ item.const_text}}</label>
                  </td> 
                   <td v-else-if="item.type == 'call_local_handler'"> 
                       <label @click="local_handler(item.field)"><u>View</u></label>
                   </td>  
...
export default {
  ...
  components: { Alerts, messageUsageSummaryComp, FilterSection,
