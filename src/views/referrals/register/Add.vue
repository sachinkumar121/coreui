...
<div>
    <CRow>
      <CCol sm="12">
        ...
        v-if="alert" />
        <form class="add-plan-form" @submit.prevent="AddRegister">
            <div class="form-body">
              <div class="row">
                  <div class="col-md-4">
                  ...
                  <div class="col-md-4">
                      <div class="form-group">
                          <label class="control-label"><b>Business Owner Email</b></label>
                          ...
                          @blur="v$.end_user_email.$touch()" 
                           ...
                           <p
                            class="error-msg"
                            v-if="v$.end_user_email.$dirty && v$.end_user_email.required.$invalid"
                  ...
                  <div class="col-md-4">
                      <div class="form-group">
                          <label class="control-label"><b>Business Owner's Phone</b></label>
                          <input 
                          class="form-control placeholder-no-fix" 
                          type="text" 
              ...
              <div class="row">
                  <div class="col-md-4">
                      <div class="form-group" >
                          ...
                          />
                          <!-- {{v$.end_user_address.$invalid()}} 
                          @blur="v$.end_user_address.$touch()" 
                          :class={invalid:v$.end_user_address.$error}
                          
                          <p class="error-msg" v-if="v$.end_user_address.$dirty && !v$.end_user_address.required">This field must not be empty.</p>
                          -->
                      </div>
                  </div>
                  <div class="col-md-4">
                      <div class="form-group">
                          <label class="control-label"><b>Platform</b></label>
              ...
              <div v-if="user_type == 1">
                <div class="row">
                  ...
                  <div class="col-md-4">
                      <div class="form-group">
                          <label class="control-label"><b>Discovered Business Name</b></label>
                            <v-select v-model="select_business_name" label="business_name" :options="options" @search = "onSearch" @update:modelValue="setBusinessId">
                  ...
                  <div class="col-md-4">
                      <div class="form-group" >
                          <label class="control-label"><b>Discovered Business Id</b></label>
                          <input 
                          class="form-control placeholder-no-fix" 
                          type="text" 
                  ...
                  <div class="col-md-4">
                      <div class="form-group" >
                          <label class="control-label"><b>Referring Partner Bus. Id</b></label>
                          <input 
                          class="form-control placeholder-no-fix" 
                          type="text" 
              ...
              <div class="row">
                  <div class="col-md-12">
                      <button  class="btn btn-success float-end">Add Referral</button>
                  </div>
              </div>
            </div>
        </form>
...
export default {
    ...
    methods:{
        ...
        setBusinessId(){
             //console.log(this.select_business_name.business_name)
             //console.log(this.select_business_name._id)
        ...
        AddRegister(e){
            ...
            if(!this.v$.$invalid){
                ...
                if(this.user_type == 1 && data.refpartner_user_id == '' || data.refpartner_business_id == '')
                {
                    ...
                    this.$schedsdk.add_referral_register(data).then((result)=>{  
                        if(result.status == 1){
