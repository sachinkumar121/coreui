<template>
    <div>
        <CHeader position="sticky" class="new-header">
            <CContainer fluid class="px-0">
                <!-- <CHeaderToggler @click="visible = !visible" /> -->
                <CRow class="w-100">
                    <CCol>
                        <div class="d-flex align-items-center page-heading">
                            <CHeaderToggler class="d-none d-lg-block" @click="store.commit('toggleSidebarNarrow')" style="margin-inline-start: -14px">
        <CIcon icon="cil-menu" size="lg" />
      </CHeaderToggler>
      <CHeaderToggler class="d-block d-lg-none" @click="store.commit('toggleSidebar')" style="margin-inline-start: -14px">
        <CIcon icon="cil-menu" size="lg" />
      </CHeaderToggler>
                            <button
                    ...
                    <CCol class="d-none d-md-inline-block" v-if="$store.state.user_data.type != '5' && $route.name != 'Manage Business'">
                        <div>
                            <SearchBox 
                                showShortcutKeys
                                @click.stop="null"
                                :initialFocus="setFocusOnSearch"
                                :initial-term="searchedMenu"
                                @input="setSearchTerm"
                                @clear-search="resetSearchTerm"
                                @on-blur="hideSearch"
                                @on-focus="performSearchOnFocus"
                                style="top:2px;"
                            />
                        </div>
                    ...
                    <CCol class="avatar-wrapper">
                        <div class="d-flex align-items-center justify-content-end">
                            <div class="parent-select-mbs d-none d-md-inline-block" v-if="ml_locations.length > 1 && $store.state.user_data.type != '5'">
                                <MbscSelect
                                    :data='ml_locations'
                                    v-model="selected_location"
                                    :default-selection="business_id"
                                    @change="(e) => changeLocation(e)"
                                    :filter="true"
                                    display="anchored"
                                    label=""
                                    labelStyle=""
                            ...
                            <CDropdown
                                variant="nav-item"
                                inNav
                                class="c-header-nav-items pr-0"
                                placement="bottom-end"
                                add-menu-classes="pt-0"
                            >
                                <CDropdownToggle
                                    placement="bottom-end"
                                    class="py-0 pe-0 ps-0 ps-sm-3 d-flex align-items-center"
                                    :caret="false"
                                >
                                ...
                                <CDropdownMenu class="pt-0 custom-dropdown">
                                    ...
                                    <CDropdownItem
                                        v-if="$store.state.user_data.type != '5'"
                                        href="javascript:void(0)"
                ...
                <CHeaderNav class="d-none d-md-inline-block mr-auto">
                </CHeaderNav>
                

                <!-- <CCollapse class="header-collapse" :visible="visible"> -->
                <CCollapse class="header-collapse">
                    <CHeaderNav>
                        <CNavItem>
                            <CNavLink href="javascript:void(0)" active> Home </CNavLink>
                        </CNavItem>
                    </CHeaderNav>
                </CCollapse>
            </CContainer>
        </CHeader>
        <!-- <div class="mx-auto mt-3 col-lg-6 col-sm-9">
            <Alerts 
                :alertData="alertData" 
                :show="show"
                @alertClosed="show = 0"
        ...
        <CModal
            ...
            aria-labelledby="FullPageScreenOverlay"
        >
            <!-- <CModalHeader :close-button="false">
            <CModalTitle id="FullPageScreenOverlay">Switching the location</CModalTitle>
            </CModalHeader> -->
            <CModalBody>
            {{alertData.message}}
            </CModalBody>
