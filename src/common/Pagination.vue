<template>
    <CPagination :align="align" :size="size" :ariaLabel="ariaLabel" :class="computedClasses">
...
export default {
    ...
    computed: {
        ...
        afterDots() {
            return (
                this.showDots &&
                this.activePage < this.pages - this.maxNextItems
            )
        },
        computedLimit() {
        ...
        lastItem() {
            return this.range >= this.pages
                ? this.pages
                : this.range - this.afterDots
        },
        itemsAmount() {
            return this.pages < this.computedLimit
                ? this.pages
                : this.computedLimit
        },
        items() {
